...
# ============================================================
# Runtime stage — imagem principal, focada em Prawn (PDF em Ruby puro,
# SEM GhostScript). Mais leve e com menor uso de memória — ideal para o
# Render Free Tier (512MB). Gera PDF por padrão (BOLETO_TEMPLATE=prawn),
# incluindo boleto, boleto+PIX e carnê.
#
# Para gerar imagens (JPG/PNG/TIF) use o Dockerfile.rghost (com GhostScript).
# ============================================================
